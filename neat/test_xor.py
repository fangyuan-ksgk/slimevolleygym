...
p = neat.Population(config) # Create multiple genomes 

# Add a stdout reporter to show progress in the terminal.
p.add_reporter(neat.StdOutReporter(False))

# Run until a solution is found.
winner = p.run(eval_genomes) # genome list as well as config in population gets passed into eval_genomes to evaluate fitness on individual network
